...
import os
import sys
# Usage: split-xml-correctly.py filename splitsizeinkb tag starttag
# .\split-xml-correctly.py c:\!\SpecCharacteritics.xml 100000 specCharacteritics SpecCharacteriticsS
# python3 split-xml-correctly.py SpecCharacteritics.xml 800000 specCharacteritics SpecCharacteriticsS
...
if __name__ == "__main__":
   if len(sys.argv) < 3:
       print("Filename or splitsize not provided:\n Usage: filesplit.py filename splitsizeinkb tag starttag")
   else:
